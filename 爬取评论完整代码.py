...
if __name__ == '__main__':
    ...
    #定义url并调用函数爬取#
    group_url = "https://www.douban.com/group/topic/180487605/?start={}"  # 将start=后的数字改为{}先空出来以便一会进行循环设置#
    for i in range(5):
        start = i * 100
...
#保存为csv文件#
commentdata.to_csv("中青报的报道.csv")

#删除存在的中间文件网页源代码"评论.text，以便下一次爬取"

path = '/Users/brittanyyaoke/PycharmProjects/dbcrawler/评论.text'  # 文件路径
